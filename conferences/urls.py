...
urlpatterns = [
    ...
    path('<slug:username>/delete/<slug:slug>', views.DeleteConferenceView.as_view(), name='conf_delete-page'),
    path('<slug:slug>', views.ConfInfoView.as_view(), name='conf_detail-page'),
